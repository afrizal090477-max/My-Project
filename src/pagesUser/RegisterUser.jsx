...
import meetingImg from "../assets/meeting.png"; // Hapus @, gunakan relative jika belum pakai alias
...
function RegisterUser() {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/user/login"); // arahkan ke login user, bukan login admin
  };
    ...
    <div className="relative flex min-h-screen">
      ...
      <div className="relative w-[600px] h-[644px] left-[120px] top-[50px] bg-white backdrop-blur-md border border-gray-200 rounded-2xl shadow-2xl pt-4 px-8">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h1 className="!text-[20px] font-semibold bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent">E-Meeting User</h1>
        </div>
